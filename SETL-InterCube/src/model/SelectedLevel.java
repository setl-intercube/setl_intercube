...
public class SelectedLevel {
	...
	public SelectedLevel(String DatasetName, String levelName, String levelPath, String filterCondition) {
		super();
	...
	public SelectedLevel(String DatasetName, String levelName, String levelPath) {
		super();
		this.DatasetName = DatasetName;
		this.levelName = levelName;
		this.levelPath = levelPath;
